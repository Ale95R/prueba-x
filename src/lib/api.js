...
// Base del API (usa env si existe; si no, puerto local 4000)
export const API =
  process.env.NEXT_PUBLIC_API_URL || "http://localhost:4000/api";

/* ==================================================
   Adaptadores Projects (front <-> api)
   FRONT usa: { id, title, description, duration, phases, members }
   API usa  : { id, name, description, duration, phases, members, active }
================================================== */
...
// Helper para parsear o lanzar error legible
